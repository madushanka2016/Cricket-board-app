...
public class InningTwoOutput implements Output {
    public JPanel show(String userInput,Repository repository){
        MatchDetails matchDetails = repository.getMatch(userInput);
        String countryBattingCode = matchDetails.getCountryTwo();
        String countryBowlingCode = matchDetails.getCountryOne();
